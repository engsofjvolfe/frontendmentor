...
- Solution URL: [Solution URL](https://github.com/engsofjvolfe/frontendmentor/tree/main/nft-preview-card-component-main)
- Live Site URL: [Site URL here](https://jvolfe-nft-preview-card.netlify.app/)
